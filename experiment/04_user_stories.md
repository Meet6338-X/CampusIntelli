...
### Why User Stories?
- Focus on user needs
- Keep development customer-focused
...
## 4. User Story Summary by Epic

| Epic | Stories | Total Points |
|------|---------|--------------|
| Authentication | US-1, US-2, US-3 | 20 |
| Academic - Timetable | 2 stories | 8 |
| Academic - Assignments | 4 stories | 24 |
| Academic - Grades | 1 story | 5 |
| Campus - Booking | 3 stories | 16 |
| Campus - Announcements | 2 stories | 8 |
| Attendance - QR | 2 stories | 16 |
| Analytics | 1 story | 8 |
| Administration | 1 story | 8 |

**Total Story Points**: 113

---

## 5.INVEST Criteria for Good User Stories
...
Create 3 user stories for:
- Faculty uploading lecture materials
- Admin managing courses
- Student viewing attendance records

### Task 2: Define Acceptance Criteria
Write detailed acceptance criteria for:
- User logout functionality
- Room booking cancellation

### Task 3: Story Points Assignment
Assign story points (Fibonacci: 1, 2, 3, 5, 8, 13) to the 3 user stories created in Task 1.
...
| Concept | Description |
|---------|-------------|
| User Story | Brief description of feature from user perspective |
